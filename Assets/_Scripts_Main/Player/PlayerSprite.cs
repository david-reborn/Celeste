...
namespace myd.celeste.demo
{
    public class PlayerSprite : UnitSprite
    {
        ...
        //    {
        //        PlayerAnimMetadata playerAnimMetadata;
        //        return this.Texture != null && PlayerSprite.FrameMetadata.TryGetValue(this.Texture.AtlasPath, out playerAnimMetadata) ? (float)playerAnimMetadata.CarryYOffset * (float)this.Scale.Y : 0.0f;
        //    }
        //}
